  ...
  return (
    <label className='swap swap-rotate'>
      ...
      <svg
        ...
        className=' swap-on fill-current p-1 md:p-0 w-8 h-8 icon icon-tabler icon-tabler-sun'
        viewBox='0 0 24 24'
        stroke-width='2'
        stroke='currentColor'
        fill='none'
      ...
      <svg
        xmlns='http://www.w3.org/2000/svg'
        className='swap-off fill-current p-1 md:p-0 w-8 h-8 icon icon-tabler icon-tabler-moon'
        viewBox='0 0 24 24'
        strokeWidth='0'
        stroke='currentColor'
        strokeLinecap='round'
